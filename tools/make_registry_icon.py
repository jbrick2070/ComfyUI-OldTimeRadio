...
if __name__ == "__main__":
    ...
    # The square GALLERY thumbnail is not drawn here: it is the operator's
    # own art, assets/otr_gallery_thumb_master.webp, and
    # scripts/build_variants.py copies its 400x400 JPEG beside every workflow.
    if "--registry-gif" not in sys.argv:
        sys.exit("refusing to overwrite the hand-finished registry card; "
                 "pass --registry-gif if that is really what you want")
