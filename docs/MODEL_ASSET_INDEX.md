...
| `kokoro` | 1 weight file(s) | auto (boot prefetch: voices + ONNX model; torch model via HF cache) | 125 profile(s) |
| `musicgen` | `facebook/musicgen-small` | auto (HF cache) | 60 profile(s) |
