...
- status: FIX IN TREE; **P0 LIVE-CONFIRMED** (leg `90f22b15` cleared P0 -- ran the full P0/P1/P2 chain vs the pre-fix ~85s P0 abort). Full-episode reverify pending the same-lane P3 fix (below).
