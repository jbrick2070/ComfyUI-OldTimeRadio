...
## ARCHIVED 2026-08-22 -- the ideogram4_local / golden-rule session's DONE block

Closed and superseded: it described the session that ended at e80c6786, two sessions back, and a reader resuming could mistake it for the current state. Grepped for standing rulings before moving; it carried none.
