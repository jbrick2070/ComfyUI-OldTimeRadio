"""docs/sprint_drafts/build3/_otr_slot_drama_contract.py -- Build 3 DRAFT.

GO_FORWARD_PLAN_v10 Build 3: `slot_drama_contract` + deterministic
contract validation.

This is a DRAFT module. It lives under docs/sprint_drafts/build3/ and
is NOT auto-imported by the node pack. Integration (moving it into
`nodes/` and wiring it into OTR_LedgerScriptWriter before the Story
Room writes) is described in WIRING_SPEC.md and happens AFTER Build 2,
BEFORE Build 4.
