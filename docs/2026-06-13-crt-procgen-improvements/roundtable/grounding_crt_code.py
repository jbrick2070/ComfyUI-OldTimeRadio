# GROUNDING -- the REAL procgen draw code (nodes/video_engine.py). Do not invent APIs beyond this.
# --- Excerpt 1: constants, fonts, _analyze_audio, _CRTRenderer.render + helpers (lines 1-380) ---
r"""
...
# --- Excerpt 2: render_video drive -- audio load + analyze (lines 1377-1411) ---
...
# --- Excerpt 3: renderer instantiation + per-frame provider (lines 1555-1566) ---
