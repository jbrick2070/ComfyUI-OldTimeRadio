"""Queue 5-act deluxe AUDIO-IN behind the live overnight jobs. Do not recycle."""
...
def main() -> int:
    ...
    payload["audio_in_5act_prompt_id"] = prompt_id
    payload["source_bank"] = "my_story"
    payload["visual_style"] = "recur_frac"
    STATUS.write_text(json.dumps(payload, indent=2), encoding="utf-8")
    print("[mystory] audio_in_5act=%s" % prompt_id, flush=True)
    return 0
