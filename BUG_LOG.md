...
- **Verify:** regression 2026-05-23 -- full `tests/` walk 2491 passed / 17 skipped / 0 failed; Bug Bible regression 16 passed / 7 skipped / 3 xfailed. **Runtime confirmation gate STILL OPEN:** an operator episode run with zero `Failed to validate prompt` lines and real Flux/HuMo output under `episodes/<ep>/stills/` + `videos/`.
