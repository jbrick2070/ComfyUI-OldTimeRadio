...
**Prior last entry:** BUG-LOCAL-227 (2026-05-14) -- 25 LFC test failures latent at S30 B8 surfaced by wide `pytest tests/` walk during S31 B1 verification. PRE-EXISTING, not an S31 regression. Suspected Phase 3/4/5/6 deletion collateral from S30 B3/B4. Triage AFTER S31 close.
...
### BUG-LOCAL-227: 25 LFC test failures latent at S30 B8 (wide walk)
- **Date:** 2026-05-14 | **Phase:** 5 | **Bible candidate:** no
- **Status:** PRE-EXISTING at S30 B8 close. Not an S31 regression.
