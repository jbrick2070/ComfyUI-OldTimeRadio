...
- `simple_3_prompt_experimental`: exposed experiment:
...
- `simple_3_prompt_experimental` / "Simple 3-Prompt Experimental"
...
- Design hope: stronger LLMs may be able to create richer stories in three
  passes than the current Python-heavy scaffold, with Python doing validation,
  schema repair, and loud failure instead of narrative trickery.
