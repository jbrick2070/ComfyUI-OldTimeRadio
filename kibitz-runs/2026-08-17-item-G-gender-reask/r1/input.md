...
neighbouring heuristic: **the gender ladder's decision margin (floor 4, ratio 3x)
must not be loosened**, because DOROTHY of Oz measures 8/3 male under a looser
estimator when her scene is crowded, and *a confident WRONG pin must stay
impossible; decline-and-roll is the accepted behaviour*.
...
* No new ledger field.
* Do not loosen the gender ladder's decision margin (floor 4, ratio 3x).
