...
LANES = {
    ...
    # the VAEs and upscaler from yuvraj108c/LTX-2.5 (stored at the repo root,
    # which keeps the HF cache path inside the Windows MAX_PATH budget),
    # byte-identical to Lightricks' own gated copies (same SHA-256). Revisions, sizes and hashes
    ...
    "ltx25_native_16gb": [
        ...
        WeightSpec(
            ...
            "9a165b41a60dd72000d756c71c32ff30a52e6ffa",
            1_472_223_346,
