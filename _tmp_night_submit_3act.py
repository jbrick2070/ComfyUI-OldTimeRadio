"""Queue cheap-cloud 3-act on :8000. Hydrate OTR_COMFY_API_KEY from User env."""
...
def main() -> int:
    ...
    sys.argv = [
        ...
        "--workflow",
        r"C:\Users\jeffr\Documents\ComfyUI\custom_nodes\ComfyUI-OldTimeRadio\workflows\variants\otr_cloud_low.json",
        "--act-count",
        "3",
        "--comfyui-url",
        "http://127.0.0.1:8000",
