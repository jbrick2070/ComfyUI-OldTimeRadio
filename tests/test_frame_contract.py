...
def test_EVERY_BOUNDED_ENGINE_CAN_SPLIT_AND_UNBOUNDED_ONES_NEED_NOT():
    ...
    assert set(unbounded) == {
        ...
        # the LIGHTNING SPEED PEER (2026-09-08) is unbounded for the same
        # reason as the whole family: distillation changes how many STEPS a
        # beat costs, never how many FRAMES it spans, so max_frames stays 0
        # and the partitioner still has nothing to split on
