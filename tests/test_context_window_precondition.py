...
def test_context_window_precondition_mistral_nemo_real_row_passes() -> None:
    """Mistral-Nemo at context_window=8192 (matches the default
    HARD_VRAM_CONTEXT_LIMIT=8192) does NOT trip the precondition.
    Pin the audio C7 baseline row's pass-through behavior.
    """
