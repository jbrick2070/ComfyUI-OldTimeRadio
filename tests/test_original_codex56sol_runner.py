...
def _responses():
    card = {"possibility_id":"p1","title_seed":"Echo Desk","premise":"Three callers hear one helpful echo.","desk_operator":{"name":"Mara Vale"},"callers":[{"name":"Ivo Reed"},{"name":"Nell Park"}],"shared_cause":"A loose grille carries desk sounds.","clue_plan":["a repeated number","a paper rustle","the same three-note whistle"],"helpful_resolution":"Mara maps the echo and returns the items."}
