...
produces a shots[] array suitable for driving the Visual sidecar
(or any interim stand-in: Diffusion360, SPAG4D, ComfyUI-Sharp).

Design doc: docs/2026-04-15-otr-to-visual-narrative-mapping.md
...
log = logging.getLogger("OTR.visual.shotlist")
