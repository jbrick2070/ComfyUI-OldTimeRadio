"""
vram_coordinator.py  --  File-lock GPU gate for Visual worker / Bark TTS.
==========================================================================
Phase A robustness: when the Visual worker eventually does GPU work
...
log = logging.getLogger("OTR.visual.vram_coordinator")
...
class VRAMCoordinator:
    ...
    Today only the Visual worker is wired to this.  Bark TTS does not
