...
- **Kokoro Announcer.** Dedicated non-Bark narrator track. Clean separation of announcer bus from character voices so ANNOUNCER has a broadcast-ready "Voice of God" cadence instead of sharing the Bark pool.
