...
- profile: `otr_24gb_native_foley` (24 GB NVIDIA (any modern card) -- NATIVE, non-GGUF video that generates its own sound. Lane ltx25_native_foley_24gb (fp8_e4m3fn, stock ComfyUI loaders, no ComfyUI-GGUF), z_image_turbo stills, Kokoro voices, Stable Audio 3. Writer Qwen3.8-27B at a 22 GB ceiling. NOT YET QUALIFIED: no live leg has completed on this profile.)
- status: draft
...
- LTX25-distilled-DiT-comfy-fp8_e4m3fn.safetensors
