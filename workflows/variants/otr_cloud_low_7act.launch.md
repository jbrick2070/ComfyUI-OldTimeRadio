# Launch recipe: otr_cloud_low_7act

GENERATED by scripts/build_variants.py -- do not hand-edit (regenerate instead). Paired variant: `workflows/variants/otr_cloud_low_7act.json`.

- profile: `otr_cloud_low_7act` (Comfy Cloud 7-act -- Sonnet 5 creative + GPT 5.6 Luna tech (Comfy Credits), same cheapest partners as the 1-act trial and 3-act graphs (Vidu Q2 Pro Fast I2V). Long paid-length episode. Needs OTR_COMFY_API_KEY.)
- status: shipping
- platform/backend/vendor: any/cpu/none
- master_hash: `1fb9745e6416ffe69ce65e5aed5419f069be2ca03a31a2c780e766fcfc5003c3`
