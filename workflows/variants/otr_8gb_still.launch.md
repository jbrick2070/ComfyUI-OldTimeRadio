...
- workflow: `otr_8gb_still` (8 GB NVIDIA -- a still image with motion, minted by SD 1.5. Lane still_motion, sd15 stills, Kokoro voices, Stable Audio 3. Writer Qwen3.5-4B at a 6.8 GB ceiling. Rebuilt from the canonical 2026-09-13; see config/workflow_matrix.json.)
- status: shipping
