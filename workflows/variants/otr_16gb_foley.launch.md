...
- profile: `otr_16gb_foley` (16 GB NVIDIA -- video that generates its own sound, mixed under the voices. Lane ltx25_native_foley_16gb (mix4x8-13.8GB) through the stock UNETLoader/CLIPLoader with no Hugging Face token, because every weight this tier asks for is ungated. z_image_turbo stills, Kokoro voices, Stable Audio 3. Writer gemma-4-12b-it at a 14.5 GB ceiling. MEASURED on an RTX 5080 Laptop 2026-09-23: one 97-frame 1664x960 clip with foley in 205.3 s. See docs/2026-09-22-native-ltx25-16gb/FINDINGS.md.)
- status: shipping
