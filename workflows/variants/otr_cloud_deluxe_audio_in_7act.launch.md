# Launch recipe: otr_cloud_deluxe_audio_in_7act

GENERATED by scripts/build_variants.py -- do not hand-edit (regenerate instead). Paired variant: `workflows/variants/otr_cloud_deluxe_audio_in_7act.json`.

- profile: `otr_cloud_deluxe_audio_in_7act` (Comfy Cloud 7-act deluxe AUDIO-IN -- GPT 5.6 Sol creative + Luna tech (Comfy Credits), LTX 2.5 Audio-to-Video driven by the episode mix. OpenRouter stays on the picker. Needs OTR_COMFY_API_KEY.)
- status: shipping
- platform/backend/vendor: any/cpu/none
- master_hash: `54fc9458b206b9305fa2cb53dd76bb283d588771a48924a39a3455f495465e19`
