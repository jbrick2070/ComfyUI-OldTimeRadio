# Launch recipe: otr_32gb_foley

GENERATED by scripts/build_variants.py -- do not hand-edit (regenerate instead). Paired variant: `workflows/variants/otr_32gb_foley.json`.

- profile: `otr_32gb_foley` (32 GB NVIDIA -- the 16 GB foley recipe on Q5_K_M weights instead of Q3_K_M. Same canvas, same lanes, same mix; the DiT is the only change. Lane ltx25_foley_plus, lumina_image stills)
- status: draft
- platform/backend/vendor: any/cuda/nvidia
- master_hash: `5e5ec493f0674873249da7138b770eb12e2e6cb5467596b8c700d0d3788864f8`
