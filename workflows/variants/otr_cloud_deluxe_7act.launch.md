# Launch recipe: otr_cloud_deluxe_7act

GENERATED by scripts/build_variants.py -- do not hand-edit (regenerate instead). Paired variant: `workflows/variants/otr_cloud_deluxe_7act.json`.

- profile: `otr_cloud_deluxe_7act` (Comfy Cloud 7-act deluxe FOLEY -- GPT 5.6 Sol creative + Luna tech (Comfy Credits), LTX 2.5 I2V generates its own bed and mixes 0.50 under the voices. OpenRouter stays on the picker. Needs OTR_COMFY_API_KEY.)
- status: shipping
- platform/backend/vendor: any/cpu/none
- master_hash: `4d73488a4bf52f0ac073bcc29e7ab4e53c450200e0a854d50806508b66e62042`
