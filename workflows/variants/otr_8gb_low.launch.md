...
- profile: `otr_8gb_low` (8 GB NVIDIA -- no video weights at all -- the procedural visualiser lanes. Lane viz_camera, which consumes no still, Kokoro voices, MusicGen. Writer Qwen3.5-4B at a 6.8 GB ceiling. Rebuilt from the canonical 2026-09-13; see docs/TIER_MATRIX.md.)
- status: shipping
- platform/backend/vendor: any/cuda/nvidia
- master_hash: `e53981860d6776db062290fe737c4328cc68678d321d682151618320347e9b30`
