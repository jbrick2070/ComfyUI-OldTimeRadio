...
- profile: `otr_8gb_low` (8 GB NVIDIA -- no video weights at all -- the procedural visualiser lanes. Lane viz_camera, flux2_klein stills, Kokoro voices, MusicGen. Writer Qwen3.5-4B at a 6.8 GB ceiling. Rebuilt from the canonical 2026-09-13; see docs/TIER_MATRIX.md.)
- status: draft
