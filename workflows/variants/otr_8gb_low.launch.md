# Launch recipe: otr_8gb_low

GENERATED by scripts/build_variants.py -- do not hand-edit (regenerate instead). Paired variant: `workflows/variants/otr_8gb_low.json`.

- profile: `otr_8gb_low` (8 GB NVIDIA -- no video weights at all -- the procedural visualiser lanes. Lane viz_camera, which consumes no still, Kokoro voices, Stable Audio 3. Writer Qwen3.5-4B at a 6.8 GB ceiling. Rebuilt from the canonical 2026-09-13; see config/workflow_matrix.json.)
- status: shipping
- platform/backend/vendor: any/cuda/nvidia
- master_hash: `871cbcb95ba640a4cc4bfa29543ed5835377c6d24ad1d211c042efc280a8e8a5`
