...
- workflow: `otr_8gb_video` (8 GB NVIDIA -- real video diffusion on LTX 0.9.8, which downloads itself (16.1 GB at queue time, no account, no licence click) and is the only video engine proven on 8 GB, 16 GB and Mac alike. SD 1.5 stills, Kokoro voices, Stable Audio 3.)
- status: shipping
- platform/backend/vendor: any/cuda/nvidia
- master_hash: `c0b1b1ea33a85b5a1031ca1a03e0cffcdf67c90df672a37f70732498c4183f16`
