...
- profile: `otr_cpu_low` (CPU only -- Sonnet 5 creative + GPT 5.6 Luna tech (Comfy Credits). The three procedural visualiser lanes draw their own frames and download no video weights. No image engine is used at all: procgen lanes consume no still. Kokoro voices, MusicGen. Needs OTR_COMFY_API_KEY. Rebuilt from the canonical 2026-09-13; see docs/TIER_MATRIX.md.)
- status: shipping
- platform/backend/vendor: any/cpu/none
- master_hash: `710482defe50a94def606cd3ac77aa47c96d77791402f2e1f29bf0cf042accba`
