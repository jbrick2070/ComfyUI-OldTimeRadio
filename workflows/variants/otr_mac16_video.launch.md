# Launch recipe: otr_mac16_video

GENERATED by scripts/build_variants.py -- do not hand-edit (regenerate instead). Paired variant: `workflows/variants/otr_mac16_video.json`.

- profile: `otr_mac16_video` (Apple Silicon -- real video diffusion on LTX 0.9.8 -- the only video engine that downloads itself. SD 1.5 stills, Kokoro voices, Stable Audio 3, no upscaler. Proven on a 16 GB M4.)
- status: shipping
- platform/backend/vendor: mac/mps/apple
- master_hash: `eab5c43f901c89c83e8f31dc2f9ec95095db07dc0dd6e64a85a143b956c76ca0`
