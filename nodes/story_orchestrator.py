...
# ---------------------------------------------------------------------------
# CLEANBREAK SENTINEL -- voice-path-cleanbreak Sprint 2 (2026-05-12)
# ---------------------------------------------------------------------------
#
# class LLMDirector was deleted on this line in Sprint 2.4. The class was
# the legacy LLM-derived production plan generator (cast / voice_assignments /
# sfx_plan / music_plan / visual_plan from a single LLM call against
# the rendered script_text). Its outputs were:
#   - voice-side consumers (Bark / Kokoro / AudioGen / ProcSFX /
#     SceneSequencer / MusicGen) -- severed in voice-path-cleanbreak P2
#     (commit 446ec81)
#   - video-side consumers (OTR_SignalLostVideo, OTR_VideoPlan) --
#     migrated to read meta.visual_plan + meta.voice_assignments +
#     meta.style from the L3 ledger in Sprint 2 (this commit)
#
# The dead helper functions ABOVE this sentinel block (DIRECTOR_PROMPT,
# DirectorJSONParseError, _build_director_json_repair_prompt,
# _validate_director_plan, _randomize_character_names,
# _generate_minimal_plan_from_voice_tags, _DIRECTOR_SCHEMA, plus any
# inline helpers used only by them) are unreferenced after the class
# delete and should be pruned in a follow-up cleanup commit.
#
# Refs: docs/voice-path-cleanbreak-execution-plan.md Sprint 2
