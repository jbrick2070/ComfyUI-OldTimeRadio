...
_NEW_LINE_ACTIONS: frozenset = frozenset(
    {"SHORTEN_LINE", "RECOMPOSE_BEAT_SAME_INTENT", "SPLIT_LINE", "MERGE_SHORT_LINES"}
)
...
_PROSE_REQUIRED_ACTIONS: frozenset = frozenset(
    {"SHORTEN_LINE", "SPLIT_LINE", "MERGE_SHORT_LINES"}
)
