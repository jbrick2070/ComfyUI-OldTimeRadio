...
# Per-line Bark inference relocated to _otr_bark_lib.py (sprint 1a clean-break);
# re-exported here so existing import/patch targets still resolve (test_core.py
# imports _clean_text_for_bark; test_bark_ledger.py patches
