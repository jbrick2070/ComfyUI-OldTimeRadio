...
class MiniMaxH3AudioInEngine(_MiniMaxH3Base):
    ...
    #: ``audio_conditioned_video`` is the EXISTING audio-conditioned family;
    #: minting a new one would put this lane outside the motion families the
    #: held-frame invariant checks and make its frozen clips exempt, the trap
    #: the transplant plan names.
