...
def assign_voice_for_slot(
    *,
    ...
    #
    # THE OWNER IS UNAFFECTED, which is what makes this safe. CastLock's
    # `_recurring_character_bank_ref` stamps a reserved row onto the character
    # it names DIRECTLY and never comes through this selector, so reserving
    # these ids cannot starve Lemmy of his own voice -- it only stops everyone
    # else borrowing it.
    #
